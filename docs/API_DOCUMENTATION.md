...
- **Global Path (Manager):** `/sarvasya/auth/login`
- **Tenant Path (Staff/Student):** `/{tenantName}/auth/login`
- **Method:** `POST`
- **Permissions:** Public
- **Payload Example:**
```json
...
### 2.1 Theme & Branding
- **Get Theme:** `GET /sarvasya/tenants/{tenantName}/theme`
- **Update Theme:** `PUT /sarvasya/tenants/{tenantName}/theme`
- **Permissions:** 
    - `GET`: Public
...
- **Create User:** `POST /{tenantName}/users`
...
- **View Limits:** `GET /sarvasya/limits?tenantId=harvard`
- **Modify Limits:** `PUT /sarvasya/limits`
- **Permissions:**
...
- **List All Tenants:** `GET /sarvasya/tenants`
- **Get Single Config:** `GET /sarvasya/tenants/{tenantId}`
- **Update Config:** `PUT /sarvasya/tenants`
- **Permissions:**
    - `GET`: All authenticated roles
    - `PUT`: `tenant-manager` only
- **Payload Example:**
...
- **URL:** `/sarvasya/tenants/{tenantId}/impersonate`
- **Method:** `POST`
- **Permissions:** `tenant-manager` only
- **Response Example:**
```json
...
- **URL:** `/sarvasya/bus-schedules/{id}`
- **Method:** `GET`
- **Permissions:** `ADMIN`, `PROFESSOR`, `USER`

#### Get Bus Schedules by Bus ID
- **URL:** `/sarvasya/bus-schedules/bus/{busId}`
- **Method:** `GET`
- **Permissions:** `ADMIN`, `PROFESSOR`, `USER`
...
#### Get Bus Pass by ID
- **URL:** `/sarvasya/bus-passes/{id}`
- **Method:** `GET`
- **Permissions:** `ADMIN`, `PROFESSOR`, `USER`

#### Get Bus Passes by User ID
- **URL:** `/sarvasya/bus-passes/user/{userId}`
- **Method:** `GET`
- **Permissions:** `ADMIN`, `PROFESSOR`, `USER`

#### Get Bus Passes by Bus ID
- **URL:** `/sarvasya/bus-passes/bus/{busId}`
- **Method:** `GET`
- **Permissions:** `ADMIN`, `PROFESSOR`, `USER`
...
- **Get Calendar Items:** `GET /{tenantName}/calendar?start={startDate}&end={endDate}`
- **Create Calendar Item:** `POST /{tenantName}/calendar`
- **Permissions:** 
    - `GET`: All authenticated roles
...
- **Get Classes:** `GET /{tenantName}/classes`
- **Create Class:** `POST /{tenantName}/classes`
...
- **Get Exams:** `GET /{tenantName}/exams`
- **Create Exam:** `POST /{tenantName}/exams`
- **Permissions:** `sarvasya-admin`, `admin`
- **Payload Example:**
```json
{
...
- **URL:** `/{tenantName}/courses`
- **Methods:** `GET`, `POST`, `DELETE`
- **Filtering:** `GET /{tenantName}/courses/department/{departmentId}`
- **Permissions:** `sarvasya-admin`, `admin` (Create/Delete)
- **Payload Example:**
```json
{
...
**Base Path:** `/sarvasya/{resource}`

- **Courses**: `/sarvasya/courses`
- **Modules**: `/sarvasya/modules`
- **Lessons**: `/sarvasya/lessons`
- **Study Materials**: `/sarvasya/studymaterials`
- **Quizzes**: `/sarvasya/quizs`
- **Exams**: `/sarvasya/exams`
- **Questions**: `/sarvasya/questions`
- **Options**: `/sarvasya/options`
- **Quiz Questions Mapping**: `/sarvasya/quizquestions`
- **Exam Questions Mapping**: `/sarvasya/examquestions`
...
**Base Path:** `/sarvasya/{tenantid}/{resource}`

- **Assessment Attempts**: `/sarvasya/{tenantid}/attempts`
- **Student Answers**: `/sarvasya/{tenantid}/studentanswers`
- **Enrollments**: `/sarvasya/{tenantid}/enrollments`
- **Payments**: `/sarvasya/{tenantid}/payments`
- **Invoices**: `/sarvasya/{tenantid}/invoices`
- **Certificates**: `/sarvasya/{tenantid}/certificates`

### Example: Course Management
- **Get All Courses**: `GET /sarvasya/courses`
- **Get Course by ID**: `GET /sarvasya/courses/{id}`
- **Create Course**: `POST /sarvasya/courses`
- **Update Course**: `PUT /sarvasya/courses/{id}`
- **Delete Course**: `DELETE /sarvasya/courses/{id}`
...
### Example: Enrollment
- **Create Enrollment**: `POST /sarvasya/{tenantid}/enrollments`
...
- **Create Module**: `POST /sarvasya/modules`
...
- **Create Lesson**: `POST /sarvasya/lessons`
...
- **Create Study Material**: `POST /sarvasya/studymaterials`
...
- **Create Quiz**: `POST /sarvasya/quizs`
...
- **Create Exam**: `POST /sarvasya/exams`
...
- **Create Question**: `POST /sarvasya/questions`
...
- **Create Option**: `POST /sarvasya/options`
...
- **Create Quiz Question**: `POST /sarvasya/quizquestions`
...
- **Create Attempt**: `POST /sarvasya/{tenantid}/attempts`
...
- **Create Student Answer**: `POST /sarvasya/{tenantid}/studentanswers`
...
- **Create Payment**: `POST /sarvasya/{tenantid}/payments`
...
- **Create Invoice**: `POST /sarvasya/{tenantid}/invoices`
...
- **Create Certificate**: `POST /sarvasya/{tenantid}/certificates`
